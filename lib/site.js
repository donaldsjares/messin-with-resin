...
var KEY = 'mwr:site';
/* Image fields plus shipping settings (ship-from ZIP + fee/threshold/fallback,
 * stored as plain strings and parsed as numbers where needed by the shipping
 * API). */
var FIELDS = ['heroImage', 'aboutImage', 'commissionImage', 'logoImage',
  'shipFromZIP', 'handlingFee', 'freeShipThreshold', 'flatRate'];
